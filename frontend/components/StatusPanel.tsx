...
export function StatusPanel({ assignmentId, uploadId, run, error }: Props) {
  return (
    <Card
      eyebrow="Pipeline"
      title="Status und Laufdaten"
    >
      ...
      {run?.pipeline_status ? (
        <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-slate-950 text-slate-100 dark:border-mdn-dark-border dark:bg-[#18191b] dark:text-mdn-dark-text">
          <div className="border-b border-white/10 dark:border-mdn-dark-border px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-300 dark:text-mdn-dark-muted">
            Pipeline-Status
          </div>
